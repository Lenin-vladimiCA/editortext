...
public class Menu_principal extends JPanel {
	...
	public Menu_principal() {
		...
		PanelContenedor.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
		...
		PanelContenedor.addMouseListener(new MouseAdapter() {
			@Override
